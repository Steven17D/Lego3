...
def components(request):
    ...
    assert "lego_manager" in request.config.inicfg.config.sections[MARK], "Missing lego_manager hostname in inifile"
...
def pytest_fixture_setup(fixturedef, request):
    ...
    def setup_class_wrapper(*args, **kwargs):
        ...
        with component_factory.acquire_component(lego_manager, *mark.args, **mark.kwargs) as wrapped_components:
